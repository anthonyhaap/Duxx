...
- **DUXXBAK® Composite Decking** (AmeriLux International) — real product line: 10 board **profiles** from the spec sheet with true face widths/thicknesses (DuxxBak Dekk 5.75", Optima/Optima Grooved 5.4", Optima LT/LT Grooved 5.28", I.Dekk S4S/T&G 5.75", I.Dekk HD 5.5–5.75", Commercial Dekk 8"); the selected profile drives the board width shown in the 3D deck. Plus the real **colors grouped by finish** — Armor Cap (Boardwalk Grey, Warm Cedar, Sedona Red, Dark Mahogany, Black Walnut), Traction (Cool Sand, Driftwood, Cedar, Mahogany, Walnut, Copper Canyon, Rustic Red) and Traction Wood Grain (River Stone, Tree Bark, Tanned Leather); the color swatches filter to the selected finish. Plus board length & direction and fascia color
- **Unofficial estimate** — at the **end** of the flow the button opens a running price tally: DUXXBAK® decking (linear feet × profile/finish rate from the 2026 dealer list), fascia, required mounting clips and fasteners, **plus railing at an editable $/linear-ft rate** — totaling an estimated project price you can download. On-screen only; no external proposal

...
- **Unofficial estimate** — the final step's button opens a pricing estimate from the **DUXXBAK® 2026 dealer list** ($/linear-ft, estimate use only): decking linear feet × profile/finish rate, fascia, required mounting clips and fasteners, with a materials subtotal and a downloadable copy
